...
@Slf4j
@SpringBootTest(classes = {TrackingConfig.class})
...
public class DispatchTrackingIntegrationTest {
    ...
    public static class KafkaTestListener {
        ...
        public AtomicInteger trackingStatusCounter = new AtomicInteger(0);
